...
public class ChessBoardUI {
  ...
  public static void displayGame(ChessBoard board, ChessGame.TeamColor perspective) {
  ...
  private static void displayBoardWhiteWithHighlights(ChessBoard
                                                              board, Set<ChessPosition> highlights, ChessPosition selectedPos) {
    printHeaders(false);
    for (int row=BOARD_SIZE; row >= 1; row--) {
  ...
  private static void displayBoardBlackWithHighlights(ChessBoard
                                                              board, Set<ChessPosition> highlights, ChessPosition selectedPos) {
    printHeaders(true);
    for (int row=1; row <= BOARD_SIZE; row++) {
  ...
  public static void displayGameWithHighlights(ChessBoard board, Collection<ChessMove> highlights, ChessGame.TeamColor perspective) {
    ...
    // Only show the board from the player's perspective with highlights
    if (perspective == ChessGame.TeamColor.WHITE) {
